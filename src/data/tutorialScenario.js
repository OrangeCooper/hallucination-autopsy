  ...
  tutorialSteps: [
    {
      step: 1,
      screen: 'learn',
      title: 'Welcome & Learn Mode',
      instruction: 'This is the Learn Mode dashboard. You can configure a scenario by selecting practice area, document type, jurisdiction, and difficulty. When you click "Generate Training Scenario," an AI creates a unique legal document with planted errors. For this tour, we will use a pre-built scenario — click "Begin Tour" to start.',
    },
    {
      step: 2,
      screen: 'case-briefing',
      title: 'Case Briefing',
      instruction: 'Read the case briefing carefully. This section tells you what the AI was asked to draft, your role as reviewer, and the professional stakes. Understanding this context is critical to accurate error detection.',
    },
    {
      step: 3,
      screen: 'document-review',
      title: 'Document Review Workspace',
      instruction: 'Click paragraphs to flag them. Select the error category and write a brief explanation (at least 30 characters). The left panel shows the document; the right panel lists your annotations. Look for fabricated citations, wrong legal standards, temporal inconsistencies, and false precision.',
    },
    {
      step: 4,
      screen: 'analysis-report',
      title: 'Analysis Report',
      instruction: 'This screen compares your flags against the planted errors. Green borders show correct identifications; red shows missed errors. Read each explanation to understand the error type. Use follow-up Q&A to explore further. The summary provides partner-level feedback.',
    },
    {
      step: 5,
      screen: 'test',
      title: 'Test Mode',
      instruction: 'Test Mode generates scenarios weighted toward your weak categories. It adapts to your skill profile. You can select an area of law, jurisdiction, and difficulty, then generate an adaptive test. Results update your skill profile. Click "Complete Tour" to finish the guided tour.',
    },
    {
      step: 6,
      screen: 'skill-profile',
      title: 'Skill Profile',
      instruction: 'Your skill profile tracks detection rates by category across all sessions. It shows overall stats, a radar chart, category details, development advice, and session history. In live mode, this builds over multiple exercises.',
    },
  ],
}
