    ...
    <div className="fixed inset-0 z-50 bg-white flex items-center justify-center">
      <div className="max-w-md w-full px-6">
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-sm font-semibold text-navy-500">Hallucination Autopsy</span>
        </div>
        <h2 className="text-base font-medium text-gray-900 mb-5">Generating Training Scenario</h2>
          ...
          {STEPS.map((step, i) => {
            ...
            return (
              <div key={step.key} className="status-step flex items-center gap-3">
                ...
                <span className={`text-sm ${isActive ? 'text-navy-600 font-medium' : isCompleted ? 'text-gray-500' : 'text-gray-400'}`}>
                  {step.label}
                </span>
              </div>
            )
  ...
  return (
    <div className="fixed inset-0 z-50 bg-white flex items-center justify-center">
      <div className="max-w-md w-full px-6 text-center">
        ...
        <h2 className="text-base font-medium text-gray-900 mb-2">Document generation failed</h2>
