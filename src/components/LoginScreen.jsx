    ...
    <div className="max-w-md mx-auto px-4 py-12">
      <div className="card p-8 text-center">
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-200 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors mb-3"
        >
        ...
        <button
          ...
          className="w-full px-4 py-2 border border-dashed border-gray-300 rounded-lg text-xs text-gray-500 hover:bg-gray-50 transition-colors"
        >
          Continue in Demo Mode (local data only)
        </button>

        {error && (
          <div className="mt-3 p-2 bg-amber-50 border border-amber-200 rounded text-xs text-amber-700">{error}</div>
        )}
