  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      ...
      const scenario = {
        ...
        assumedRole: parsed.assumedRole || `You are reviewing an AI-generated ${config.documentType} for accuracy in the area of ${config.practiceArea} law.`,
        professionalStakes: parsed.professionalStakes || `Errors in this document could lead to incorrect legal advice, adverse rulings, or professional liability.`,
